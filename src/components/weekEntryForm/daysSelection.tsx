    ...
    return (
        <FormControl required error={error}>
            <FormGroup className={classes.checkboxes}>
                <FormControlLabel
                    control={<Checkbox checked={allDays} value='all' onChange={handleChange} />}
                    label='All'
                    labelPlacement='top'
                />
                <FormControlLabel
                    control={<Checkbox checked={monday} value='monday' onChange={handleChange} />}
                    label='Monday'
                    labelPlacement='top'
                />
                <FormControlLabel
                    control={<Checkbox checked={tuesday} value='tuesday' onChange={handleChange} />}
                    label='Tuesday'
                    labelPlacement='top'
                />
                <FormControlLabel
                    control={<Checkbox checked={wednesday} value='wednesday' onChange={handleChange} />}
                    label='Wednesday'
                    labelPlacement='top'
                />
                <FormControlLabel
                    control={<Checkbox checked={thursday} value='thursday' onChange={handleChange} />}
                    label='Thursday'
                    labelPlacement='top'
                />
                <FormControlLabel
                    control={<Checkbox checked={friday} value='friday' onChange={handleChange} />}
                    label='Friday'
                    labelPlacement='top'
                />
            </FormGroup>
